...
# 产物: app/src/main/assets/tools/usr/bin/fish
set -eux
...
# 10. 复制到 assets
cd "$GITHUB_WORKSPACE"
cp "$FISH_BIN" "app/src/main/assets/tools/usr/bin/fish"
chmod +x "app/src/main/assets/tools/usr/bin/fish"
ls -la "app/src/main/assets/tools/usr/bin/fish"
echo "fish 构建完成!"
