...
# 产物: app/src/main/assets/tools/usr/bin/{dropbear,dropbearkey}
set -eux
...
cd "$GITHUB_WORKSPACE"
cp "/tmp/dropbear-${DROPBEAR_VERSION}/dropbear"    "app/src/main/assets/tools/usr/bin/dropbear"
cp "/tmp/dropbear-${DROPBEAR_VERSION}/dropbearkey" "app/src/main/assets/tools/usr/bin/dropbearkey"
ls -la "app/src/main/assets/tools/usr/bin/dropbear" "app/src/main/assets/tools/usr/bin/dropbearkey"
